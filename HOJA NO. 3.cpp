...
// Funcion para mostrar el nombre del estudiante
void mostrarNombre() {
    cout << " " << endl;
    cout << "SISTEMA DE PILA DINAMICA" << endl;
    cout << "Estudiante: Jonathan Juan David Osorio Pascual" << endl;
    cout << "Carne: 9941-24-14047" << endl;
    cout << "" << endl;
}

// Funcion para insertar elemento
void push(int valor) {
    Nodo* nuevo = new Nodo();
    nuevo->dato = valor;
...
// Funcion para mostrar toda la pila
void mostrar() {
    if (tope == NULL) {
        cout << "Error: Pila vacia" << endl;
        return;
...
void vaciar() {
    ...
    cout << "Pila vaciada. Se eliminaron " << cont << " elementos" << endl;
}
...
int main() {
    ...
    do {
        ...
        if (opcion == 1) {
            ...
            cout << "Total: " << contar() << " elementos" << endl;
        }
        else if (opcion == 6) {
            if (tope == NULL) {
                cout << "Error: Pila vacia" << endl;
